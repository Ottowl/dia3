                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (valid) {
                      ...
                      if (result) {
                        showTopSnackBar(Overlay.of(context), CustomSnackBar.success(message: 'Efetuado com Sucesso'));
                        Navigator.of(context).pushNamedAndRemoveUntil(AppRoutes.home, (route) => false);
                      } else {
                        showTopSnackBar(Overlay.of(context), CustomSnackBar.error(message: 'Codigo Invalido'));
                      }
                    }
                  },
                  child: const Row(
